...
?> <main><div class="container-fluid capa"><div class="row"><img src="img/jurisprudencia.jpg"></div><!-- row --></div><!-- container --><div class="container default"><div class="row"><div class="col-sm-2"></div><div class="col-sm-10 jurisprudence"><div class="row"><div class="col-12 col-sm-4"><div class="accordion" id="accordionExample"> <?php								
		 		  ...
		 		  ?> <div class="card"><div class="card-header" id="headingOne"><h2 class="mb-0"><button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapse<?php echo $g->id_grupo; ?>" aria-expanded="true" aria-controls="collapseOne"> <?php echo $g->grupo_nome; ?> </button></h2><i class="fas fa-angle-down"></i></div><div id="collapse<?php echo $g->id_grupo; ?>" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample"><div class="row"><div class="col-12"><div class="list-group" id="list-tab" role="tablist"> <?php echo $menu; ?> </div></div></div></div></div><?php } ?> <?php } ?> </div></div><div class="col-12 col-sm-8 jurisprudence"><div class="tab-content" id="nav-tabContent"> <?php echo $cont; ?> </div></div></div><!-- col-sm-10--></div><!-- row --></div><!--container --></div></main> <?php
