...
?> <main><div class="container-fluid capa"><div class="row"><img src="img/entrevistas.png"></div><!-- row --></div><!-- container --><div class="container default"><div class="row"><div class="col-sm-2"></div><div class="col-sm-10 interview"><div class="row"><div class="col-12 col-sm-4"><div class="list-group" id="list-tab" role="tablist"> <?php if ($entrevistas && $entrevistas->num_rows > 0) {
				...
				?> <?php echo $menu; ?> <!--<a class="list-group-item list-group-item-action active" data-toggle="list" href="#service1" role="tab" aria-controls="home"><i class="fas fa-angle-right"></i>Lorem ipsum </a>
			      ...
			      <a class="list-group-item list-group-item-action" data-toggle="list" href="#service4" role="tab" aria-controls="settings"><i class="fas fa-angle-right"></i>Lorem ipsum</a>--></div></div><div class="col-12 col-sm-8"><div class="tab-content" id="nav-tabContent"> <?php echo $cont; ?> <!--<div class="tab-pane fade show active" id="service1" role="tabpanel" aria-labelledby="list-home-list">
			      	<div class="card card-default mb-3">
					  <div class="row no-gutters">				    
					    <div class="col-md-12">
					      <div class="card-body">
			      ...
			      <div class="tab-pane fade" id="service4" role="tabpanel" aria-labelledby="list-settings-list">4</div>--></div></div></div></div><!-- col-sm-10--></div><!-- row --></div><!--container --></main> <?php
