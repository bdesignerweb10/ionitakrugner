...
?> <main><div class="container-fluid capa"><div class="row"><img src="img/servicos.png"></div><!-- row --></div><!-- container --><div class="container default"><div class="row"><div class="col-sm-2"></div><div class="col-sm-10 services"><div class="row"><div class="col-12 col-sm-4"><div class="list-group" id="list-tab" role="tablist"> <?php if ($servicos && $servicos->num_rows > 0) {
				 		...
				 		?> <?php echo $menu; ?> </div></div><div class="col-12 col-sm-8"><div class="tab-content" id="nav-tabContent"> <?php echo $cont; ?> </div></div></div></div><!-- col-sm-10--></div><!-- row --></div><!--container --></main> <?php
