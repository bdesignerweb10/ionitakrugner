				      ...
				      <div class="row">
						  <div class="col-12">
						    <div class="list-group" id="list-tab" role="tablist">
						      <a class="list-group-item list-group-item-action active" id="list-home-list" data-toggle="list" href="#list-home" role="tab" aria-controls="home">Lorem ipsum dolor sit amet</a>
					    ...
					    <div class="col-md-12">
					      <div class="card-body">
					        <div class="row">
						        ...
						        <div class="col-sm-3">
						        	<span class="print"><a href=""> Abrir/Imprimir <i class="fas fa-print"></i></a></span>
						        </div>
					        </div>					        					        
