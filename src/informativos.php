				    	...
				    	<div class="col-md-12">
				      		<div class="card-body">
				      			<div class="row">
								    ...
								    <div class="col-sm-12">    
								        <p class="card-text"><?php echo nl2br (substr ($info->descricao, 0, 450)); ?> <a href="info.php?id=<?php echo $info->id_info; ?>" class="blog-link">[...]</a></p>								        
								    </div>    
						    	</div><!-- row -->
				      		</div>
				    	</div>
				...
				<nav aria-label="Page navigation example">
				  <ul class="pagination">
				    <li class="page-item">
				      ...
				      <a class="page-link" href="informativos.php?pagina=<?php echo $pagina_anterior; ?>" aria-label="Previous">
					...
					for($i = 1; $i < $num_pagina + 1; $i++){ ?>
						<li class="page-item"><a class="page-link" href="informativos.php?pagina=<?php echo $i; ?>"><?php echo $i; ?></a></li>
					<?php } ?>
				    ...
				    <li class="page-item">
				      ...
				      <a class="page-link" href="informativos.php?pagina=<?php echo $pagina_posterior; ?>" aria-label="Next">
