	...
	<div class="container default">
		<div class="row">
			<?php								
		 	...
		 	<div class="col-sm-2"></div>
		 	<div class="col-sm-1">
		 		<img class="blog-img" src="img/informativos/<?php echo $info->nome; ?>">
		 	</div>
			<div class="col-sm-9">
				<h5 class="card-title headline"><?php echo $info->titulo; ?></h5>
				<p class="post-text"><?php echo nl2br (substr ($info->descricao, 0, 250)); ?> [...]</p>
				<p><a href="info.php?id=<?php echo $info->id_info; ?>" class="blog-link">Saiba Mais</a></p>
			</div>
