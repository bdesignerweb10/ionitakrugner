		...
		<div class="row">
			...
			<div class="col-sm-4">
				...
				<div class="input-group">					
					<input class="form-control info-search" type="search" name="pesquisar" id="pesquisar" placeholder="Buscar por assunto" aria-label="Search" style="border-right: none; border-color: #1b5a6c; font-size: 13px; padding: 18px 10px;">
	...
	<div class="container">
		<div class="row blog">
			...
			<div class="col-sm-5">
				...
				<p class="blog-text"><?php echo nl2br (substr ($dest->descricao, 0, 650)); ?> [...]</p>
